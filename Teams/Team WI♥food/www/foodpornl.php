            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">meine rezepte</a>
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="foodpornl.php">foodporn<span class="sr-only">(current)</span></a>
                    </li>
                    <div class="dropdown">
