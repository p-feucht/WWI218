            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="hotlist.php">hot list<span class="sr-only">(current)</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="col-md-8">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <a href="lasagne.php" class="btn btn-primary">zum Rezept... &rarr;</a>
                    </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <a href="burger.php" class="btn btn-primary">Zum Rezept &rarr;</a>
                    </div>
                    <div class="card-footer text-muted">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <a href="pizza_hawaii.php" class="btn btn-primary">Zum Rezept &rarr;</a>
                    </div>
                    <div class="card-footer text-muted">
