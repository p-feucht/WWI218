...
<div class="bottom-result">
    ...
    $sql = "SELECT DISTINCT U.UName,U.Link,S.StName FROM Unternehmen U, bietet_an B, Studiengang S WHERE U.UID= B.UID AND B.StKuerzel = 'RUR' AND S.StKuerzel = B.StKuerzel";
